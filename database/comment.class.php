...
class Comment
{
  ...
  static function addComment(PDO $db, int $userId, string $ticketId, string $content)
  {
    $stmt = $db->prepare('
    INSERT INTO Comment (content, idCreator, idTicket) VALUES (?, ?, ?);
      ');
    $stmt->execute(array($content, $userId, $ticketId));
  }
